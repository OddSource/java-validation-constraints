...
/**
 * Composite constraint annotation that enforces {@link NotNull @NotNull} and {@link DecimalMax @DecimalMax}.
 *
...
@NotNull
@DecimalMax("0")
public @interface NotNullDecimalMax
{
	/**
	...
	String message() default "{net.nicholaswilliams.java.validation.NotNullDecimalMax.message}";
