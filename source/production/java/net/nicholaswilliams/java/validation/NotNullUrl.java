...
/**
 * Composite constraint annotation that enforces {@link NotNull @NotNull} and {@link Url @Url}.
 *
...
public @interface NotNullUrl
{
	 ...
	 * @see Url#protocols
	 */
	@OverridesAttribute(constraint = Url.class, name = "protocols")
	 ...
	 * @see Url#host
	 */
	@OverridesAttribute(constraint = Url.class, name = "host")
	String[] host() default { };
	 ...
	 * @see Url#port
	 */
	@OverridesAttribute(constraint = Url.class, name = "port")
	int[] port() default { };

	String message() default "{net.nicholaswilliams.java.validation.NotNullUrl.message}";
